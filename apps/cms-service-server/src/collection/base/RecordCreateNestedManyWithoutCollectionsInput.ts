...
@InputType()
class RecordCreateNestedManyWithoutCollectionsInput {
...
export { RecordCreateNestedManyWithoutCollectionsInput as RecordCreateNestedManyWithoutCollectionsInput };
